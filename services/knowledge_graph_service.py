    ...
    if not concept_names:
        ...
        try:
            result = await driver.execute_query(
                ...
                WITH e.name AS name,
                     size([(e)-[:IS_A|PART_OF|CONTAINS|INSTANCE_OF|CAUSES|PREVENTS|ENABLES|IMPROVES|INHIBITS|USES|REQUIRES|PRODUCES|IMPLEMENTS|REPLACES|EXTENDS|CONTRASTS|SIMILAR_TO|OUTPERFORMS|DEFINED_AS|HAS_PROPERTY|MEASURED_BY|APPLIES_TO|PRECEDES|FOLLOWS|CO_OCCURS|INPUTS|TRANSFORMS|CREATED_BY|SOLVES|VIOLATES|RELATED_TO]-() | 1]) AS degree
